import type { User, Goal, LastSession, Session, Resource, Message } from "@/types"
...
export const lastSession: LastSession = {
  id: "s7",
  ...
  durationMin: 18,
  summary:
    "We talked about how this week's travel made lunches harder. Mira noticed she defaulted to coffee + a pastry on the road, then felt depleted by 3pm.",
  actionSteps: [
...
export const weekStreak: boolean[] = [true, true, true, false, true, true, false]
