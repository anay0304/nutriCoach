...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-ink/34 backdrop-blur-sm",
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "w-[min(560px,92vw)] max-h-[88vh] overflow-y-auto",
        "bg-surface rounded-xl shadow-3",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("font-serif text-2xl tracking-tight text-ink", className)}
    {...props}
  />
))
